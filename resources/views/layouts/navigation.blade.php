        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                <div class="shrink-0 flex items-center gap-3">
                    ...
                    <span class="font-bold text-xl text-white hidden md:block">e<span
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-slate-800 hover:text-slate-300 focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-slate-400 hover:text-slate-500 hover:bg-slate-900 focus:outline-none focus:bg-slate-900 focus:text-slate-500 transition duration-150 ease-in-out">
