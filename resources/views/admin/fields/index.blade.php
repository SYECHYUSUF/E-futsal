...
@section('content')
    <div class="p-6">
        ...
        @if (session('success'))
            <div
                class="mb-6 bg-emerald-800/50 border border-emerald-700 text-emerald-400 px-4 py-3 rounded-xl flex items-center gap-3">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('admin.fields.show', $field->id) }}"
                                            class="p-2 bg-slate-700 text-blue-400 rounded-lg hover:bg-slate-600 transition tooltip"
                                            title="Lihat Detail">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a href="{{ route('admin.fields.edit', $field->id) }}"
                                            class="p-2 bg-slate-700 text-amber-400 rounded-lg hover:bg-slate-600 transition"
                                            title="Edit">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <form action="{{ route('admin.fields.destroy', $field->id) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="p-2 bg-slate-700 text-red-400 rounded-lg hover:bg-red-900/50 transition"
                                                title="Hapus">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center text-slate-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <a href="{{ route('admin.fields.create') }}"
                                            class="mt-2 text-emerald-400 hover:text-emerald-300 text-sm font-bold">Tambah
                                            Sekarang &rarr;</a>
                                    </div>
                                </td>
                            </tr>
