        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-400">
                    ...
                    <li><a href="{{ route('customer.fields.index') }}" class="hover:text-emerald-400 transition-colors">Daftar Lapangan</a></li>
                    <li><a href="{{ route('reservations.create') }}" class="hover:text-emerald-400 transition-colors">Booking Lapangan</a></li>
                </ul>
            </div>
