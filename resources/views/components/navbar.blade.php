<nav x-data="{ open: false, scrolled: false }" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('lapangan.index') }}" class="text-sm font-medium {{ request()->routeIs('lapangan.index') ? 'text-emerald-400' : 'text-slate-300 hover:text-white' }} transition-colors">Lapangan</a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden bg-slate-900 border-t border-slate-800 shadow-xl absolute w-full">
        <div class="pt-2 pb-3 space-y-1 px-4">
            ...
            <a href="{{ route('lapangan.index') }}" class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('lapangan.index') ? 'text-emerald-400 bg-slate-800' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">Lapangan</a>
            ...
            <a href="{{ route('reservasi.create') }}" class="block px-3 py-2 rounded-md text-base font-medium text-emerald-400 hover:text-emerald-300">Booking Sekarang</a>
        </div>
